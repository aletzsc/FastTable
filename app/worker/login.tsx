...
const styles = StyleSheet.create({
  ...
  intro: { fontSize: 15, color: FtColors.textMuted, marginBottom: 22, lineHeight: 23 },
  field: { marginBottom: 16 },
  label: { fontSize: 13, fontWeight: '700', color: FtColors.text, marginBottom: 8, letterSpacing: 0.2 },
  input: {
    borderWidth: 1,
  ...
  primaryBtnText: { color: FtColors.onAccent, fontSize: 16, fontWeight: '800', letterSpacing: 0.2 },

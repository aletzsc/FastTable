...
const styles = StyleSheet.create({
  ...
  controlBtnText: { color: FtColors.onAccent, fontWeight: '700', fontSize: 14 },
  ...
  pedidoPlato: { fontSize: 20, fontWeight: '800', color: FtColors.text, marginTop: 6 },
  notaBox: {
    marginTop: 12,
    padding: 12,
    borderRadius: 12,
  ...
  btnListoText: { color: FtColors.onAccent, fontWeight: '800', fontSize: 16 },
